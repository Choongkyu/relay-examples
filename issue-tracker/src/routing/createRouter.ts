 ...
 */
export default function createRouter(routes: any, options: any) {
  // Initialize history
  ...
  const cleanup = history.listen((location: any, action: any) => {
